            ...
            try {
                ...
                if ($str = file_get_contents($this->href)) {
                    if ($xr->XML($str)) {
                        ...
                        trigger_error("File " . $this->href . " XMLReader reading error in file " . __FILE__ . " line " . __LINE__);
                } else
                    trigger_error("File " . $this->href . " reading error in file " . __FILE__ . " line " . __LINE__);
            } catch (\Exception $e) {
